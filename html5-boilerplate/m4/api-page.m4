...
<div class="boxtitle boxtitlenoindent">CONNECT TO INWESTUJ W FIRMY</div>
<div class="boxpanel apipanel">
        <p>
        Inwestuj w Firmy provides a public API for providing summary and detailed information
        on our listings.  This is the same API that we use internally.  We eat our own cooking,
        so to speak.  Some functions are callable only by inwestuj-w-firmy admins for security,
...
<div class="boxpanel apipanel">
        ...
        provide a link back to inwestuj-w-firmy on your site or application and clearly state
        that the data is coming from inwestuj-w-firmy.  We reserve the right to block access
...
<pre name="code" class="brush: js">
{
    ...
    more_results_url: :url
        ...
        <dd>
            <p>
            Returns the top ranked listings on inwestuj-w-firmy.  The algorithm used is fully explained in the FAQ, it functions as an exponentially time-decayed
...
<!--
        ...
        <dd>
            <p>
            Returns the most valued active listings on inwestuj-w-firmy, ordered by total accepted bids descending.
            If more listings are available, they can be obtained by the <code>more_results_url</code> property of the <code>listings_props</code> in the response.
            </p>
        </dd>
        <div class="apidetail">
...
-->
        ...
        <dd>
            <p>
            Returns the latest listings on inwestuj-w-firmy, ordered by posting date descending.  Thus, the newest listings are returned first.
            If more listings are available, they can be obtained by the <code>more_results_url</code> property of the <code>listings_props</code> in the response.
            </p>
        </dd>
        <div class="apidetail">
...
<pre name="code" class="brush: js">
{
    ...
    <p>Search for a set of listings using category, location, and keyword matches.</p>
        ...
        <dd>
            <p>
            Returns listings on inwestuj-w-firmy matching a given category.  The most recently posted listings are returned first.
            If more listings are available, they can be obtained by the <code>more_results_url</code> property of the <code>listings_props</code> in the response.
            </p>
        </dd>
        <div class="apidetail">
...
<pre name="code" class="brush: js">
{
    ...
    more_results_url: :url
        ...
        <dd>
            <p>
            Returns listings on inwestuj-w-firmy matching a given location.  The most recently posted listings are returned first.
            If more listings are available, they can be obtained by the <code>more_results_url</code> property of the <code>listings_props</code> in the response.
            </p>
        </dd>
        <div class="apidetail">
...
<pre name="code" class="brush: js">
{
    ...
    more_results_url: :url
        ...
        <dd>
            <p>
            Returns listings on inwestuj-w-firmy matching a given set of keywords.  Revelancy ranking is applied, with the most relevant listings returned first.
            If more listings are available, they can be obtained by the <code>more_results_url</code> property of the <code>listings_props</code> in the response.
            </p>
        </dd>
        <div class="apidetail">
    ...
    <p>Get and update information on an individual company listing</p>
        ...
        <div class="apidetail">
            ...
            <ul>
                ...
                <li><code class="apiprop">.created_date</code> date user created the listing on inwestuj-w-firmy</li>
...
-->
        ...
        <dd>
            ...
            listing is returned.  The happens because the user may only have one new listing at a time in the inwestuj-w-firmy system.
...
<pre name="code" class="brush: js">
{
    ...
    financials_url: :financials_url
        ...
        <dd>
            <p>
            Submits the user&rsquo;s new listing for approval by a inwestuj-w-firmy admin.  No ID is passed since the user may only have one pending listing at a time.
        ...
        <dd>
            ...
            as per the inwestuj-w-firmy data retention policy.
            </p>
        </dd>
        <div class="apidetail">
            <h4>Parameters</h4>
    ...
    <p>Find the set of location groupings, roughly city/state/country metropolitan areas, containing startups on this site</p>
        ...
        <dd>
            <p>
            Return the most active locations for inwestuj-w-firmy.  The returned location names can be used as a location value for the search API.
            </p>
        </dd>
        <div class="apidetail">
            <h4>Parameters</h4>
...
<pre name="code" class="brush: js">
{
    ...
    ...
        ...
        <dd>
            <p>
            Return all locations for all listings in inwestuj-w-firmy in an abbreviated format.  Suitable for efficient display of all
...
[
    ...
    <div class="boxpanel apipanel">
    <p>Find information on the various venture-capital categories supported by inwestuj-w-firmy including a list of startups for each category</p>

        <dt>GET /listing/categories</dt>
        <dd>
            <p>
            Return all company categories for listings.  This is a list of the possible different categories of a company within the inwestuj-w-firmy system.
            </p>
        </dd>
        <div class="apidetail">
            <h4>Parameters</h4>
...
-->
                ...
                <li><code>admin</code> <var>true</var> iff this user is a inwestuj-w-firmy administrator</li>
            </ul>
            <h4>Test</h4>
...
<pre name="code" class="brush: js">
{
    ...
    <div class="boxpanel apipanel">
    <p>Perform administrative tasks on inwestuj-w-firmy; you must have administrative rights as a logged in user in order for these calls to work</p>

        <dt>GET /listing/posted</dt>
        <dd>
            <p>
            Returns posted status listings, that is, those which have been submitted by a user and are awaiting approval by a inwestuj-w-firmy admin.
            Can only be called by a inwestuj-w-firmy admin.
            If more listings are available, they can be obtained by the <code>more_results_url</code> property of the <code>listings_props</code> in the response.
            </p>
        </dd>
        <div class="apidetail">
...
<pre name="code" class="brush: js">
{
    ...
    more_results_url: :url
        ...
        <dd>
            <p>
            Returns frozen status listings, that is, those which have been frozen by a inwestuj-w-firmy admin.  Can only be called by a inwestuj-w-firmy admin.
            If more listings are available, they can be obtained by the <code>more_results_url</code> property of the <code>listings_props</code> in the response.
            </p>
        </dd>
        <div class="apidetail">
...
<pre name="code" class="brush: js">
{
    ...
    more_results_url: :url
        ...
        <dd>
            <p>
            Get the list of all inwestuj-w-firmy users.  Can only be called by admins.
            </p>
        </dd>
        <div class="apidetail">
            <h4>Parameters</h4>
