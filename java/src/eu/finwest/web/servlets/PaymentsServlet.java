	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			out.println("<form method=\"POST\" action=\"/system/download_sms_payments.csv\">"
					+ "<input type=\"submit\" value=\"Download sms payments\"/></form><br/>");
			out.println("<form method=\"POST\" action=\"/system/get_sms_payments.html\">"
					+ "<input type=\"submit\" value=\"Get sms payments\"/></form><br/><br/>");
			
			out.println("<form method=\"POST\" action=\"/system/download_sms_payments_report.csv\">"
					+ "<input type=\"submit\" value=\"Get sms payments report\"/></form><br/><br/>");
