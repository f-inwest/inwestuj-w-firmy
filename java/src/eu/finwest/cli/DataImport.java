...
public class DataImport {
	...
	private Options createCliOptions() {
		...
		options.addOption(OptionBuilder.withArgName("domain")
                .hasArg()
                .withDescription("application domain, eg. inwestuj-w-firmy.appspot.com, defaults to localhost")
                .create("domain"));
		options.addOption(OptionBuilder.withArgName("port")
                ...
                .create("port"));
		options.addOption(new Option( "mock", "imports mock data from inwestuj-w-firmy sources"));
