...
//	    props.put("mail.smtp.socks.port", "8080");
	...
	public NotificationVO prepareNotificaiton() {
		...
		notif.setUserEmail("userEmail@inwestujwfirmy.pl");
		...
		notif.setRead(false);
		notif.setLink("http://www.inwestujwfirmy.pl");
		notif.setTitle("New listing 'zix.it' posted");
		notif.setText1("A new listing 'zix.it' has been posted by 'listingOwner' on inwestujwfirmy.pl");
		notif.setText2("");
		notif.setText3("Please visit <a href=\"http://www.inwestujwfirmy.pl\">company's page at inwestujwfirmy.pl</a>.");
	...
	public boolean sendListingNotification(String emailTo) {
		...
		String htmlTemplateFile = "E:/projects/inwestuj-w-firmy/war/WEB-INF/email-templates/notification.html";
		try {
			...
			sendHtml("admin@inwestujwfirmy.pl", emailTo, subject, htmlBody);
			return true;
		} catch (Exception e) {
			e.printStackTrace();
			return false;
...
//		password = new String(console.readPassword("Password for account '" + userName + "': "));
		...
		new HtmlEmail().send(from, to, "Welcome to inwestuj-w-firmy", "E:/projects/inwestuj-w-firmy/email-templates/html/email-welcome-to-inwestuj-w-firmy.html");
		new HtmlEmail().send(from, to, "This week on inwestuj-w-firmy", "E:/projects/inwestuj-w-firmy/email-templates/html/email-this-week-on-inwestuj-w-firmy.html");
		new HtmlEmail().send(from, to, "Listing 'Social Recommendations' received bid!", "E:/projects/inwestuj-w-firmy/email-templates/html/email-owner-receives-bid.html");
		*/
