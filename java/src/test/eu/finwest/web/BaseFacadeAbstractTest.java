...
public abstract class BaseFacadeAbstractTest {
	...
	private LocalServiceTestHelper helper = new LocalServiceTestHelper(new LocalTaskQueueTestConfig(),
			...
			new LocalDatastoreServiceTestConfig().setNoStorage(false).setBackingStoreLocation("tests/temp_test_data.bin"))
				...
				.setEnvEmail("jpfowler@inwestujwfirmy.pl").setEnvAuthDomain("google.com");
...
//		}
//
//		user = new SBUser("admin@inwestujwfirmy.pl", "The Admin", "admin", "+1099111222333", "Furstenwall 200, Dusseldorf, Germany",
//				true, false, Status.ACTIVE);
//		ofy.put(user);
//		admin = DtoToVoConverter.convert(user);
//		list.add(user);
//
//		user = new SBUser("nonactive@inwestujwfirmy.pl", "Not active", "notactive", "+1099111222333", "Furstenwall 200, Dusseldorf, Germany",
