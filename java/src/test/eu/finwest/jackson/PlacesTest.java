package test.eu.finwest.jackson;
...
public class PlacesTest {
	...
	public void test() {
		try {
			String places = callPlacesSearch("-33.8670522,151.1957362", "1000", "inwestuj-w-firmy");
			System.out.println(places);

			//callAddPlace("-40.8670525", "179.1957380", "50", "inwestuj-w-firmy 3", "bar");
			//callAddPlace("-40.8670515", "`", "50", "inwestuj-w-firmy 4", "bar");

			System.out.println("****************AFTER ADDING PLACES ********************");
			places = callPlacesSearch("-33.8670522,151.1957362", "1000", "inwestuj-w-firmy");
			System.out.println(places);
		} catch (Exception e) {
